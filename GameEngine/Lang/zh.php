...
define('NO_REPORTS', "暂无可用战报");
define('ATTACKER', 'Attacker');
define('NATAR_COUNTERFORCE', 'Natar Counterforce');
define('FROM_THE_VILL', "来自村庄");
...
define('ARTEFACTS_AREA', '你附近的宝物');
define('NO_ARTEFACTS_AREA', '你附近没有宝物。');
define('OWN_ARTEFACTS', '你的宝物');
define('CONQUERED', '已征服');
define('DISTANCE', '距离');
define('EFFECT', '效果');
define('ACCOUNT', '账号');
define('SMALL_ARTEFACTS', '小型宝物');
define('LARGE_ARTEFACTS', '大型宝物');
define('NO_ARTEFACTS', '没有宝物。');
define('ANY_ARTEFACTS', '你没有任何宝物。');
define('OWNER', '所有者');
...
define('TZ_ACTIVATION_AVAILBLE_IN', '可激活时间：');
define('TZ_ACTIVATION_CODE', '激活码：');
define('TZ_ADD', '添加');
define('TZ_ADD_2', '添加');
define('TZ_ALLIANCE_ID', '联盟 ID');
define('TZ_ARRIVED', '到达：');
define('TZ_ASSIGN_TO_POSITION', '分配到职位');
define('TZ_AS_SOON_AS_A_PLAYER_YOU_INVITED_FO', '您邀请的玩家一旦建立其');
define('TZ_ATTACKS', '攻击');
define('TZ_BOLD', '粗体');
define('TZ_BUILDING', '建筑');
define('TZ_CATAPULT_TARGET', '投石车目标');
define('TZ_CLICK_TO_COPY', '点击复制');
define('TZ_CLIMBERS_OF_THE_WEEK', '本周上升榜');
define('TZ_CLOCK', '时钟');
define('TZ_CONTINUE_WITH_THE_NEXT_TASK', '继续下一个任务。');
define('TZ_CREATE', '创建');
define('TZ_CREATE_A_NEW_LIST', '创建新列表');
define('TZ_DESTINATION', '目的地：');
define('TZ_DOES_NOT_EXIST', '不存在。');
define('TZ_DOWNLOAD', '下载');
define('TZ_EVENT', '事件');
define('TZ_FEATURES_OF_TRAVIAN', 'Travian 的功能');
define('TZ_FORUM_NAME', '论坛名称');
define('TZ_FORWARD', '下一页');
define('TZ_GOLD', '金币。');
define('TZ_HERO_DEF_BONUS', '英雄（防御加成）');
define('TZ_HERO_FIGHTING_STRENGTH', '英雄（战斗力）');
define('TZ_HERO_OFF_BONUS', '英雄（进攻加成）');
define('TZ_HOUR', '小时');
define('TZ_HOW_IS_IT_DONE', '如何操作？');
define('TZ_HRS', '小时');
define('TZ_HRS_2', '小时');
define('TZ_IF_YOU_GET_NEW_PLAYERS_TO_OPEN_AN', '如果您带来的新玩家开设账户并建立第二个村庄，您将获得');
define('TZ_IN_YOUR_POST_BECAUSE_IT_CAN_CAUSE', '因为它可能导致 BBCode 系统出现问题。');
define('TZ_ITALIC', '斜体');
define('TZ_LAST_TARGETS', '最近的目标：');
define('TZ_LIST_NAME', '列表名称：');
define('TZ_LOOK_FOR_YOUR_RANK_IN_THE_STATISTI', '在统计中查找您的排名并在此输入。');
define('TZ_MACEMAN', '棍棒兵');
define('TZ_MEMBERS', '成员');
define('TZ_MEMBER_SINCE', '加入时间');
define('TZ_NAME', '名称：');
define('TZ_NO', '编号');
define('TZ_NOT_CODED_YET', '（尚未实现）');
define('TZ_NO_EMAIL_RECEIVED', '没有收到电子邮件？');
define('TZ_N_15_GOLD', '15 金币');
define('TZ_N_1_INVITE_YOUR_FRIENDS_VIA_EMAIL', '1) 通过电子邮件邀请好友');
define('TZ_N_20_GOLD', '20 金币');
define('TZ_N_2_COPY_YOUR_PERSONAL_REF_LINK_AN', '2) 复制您的个人推荐链接并分享！');
define('TZ_N_50_GOLD', '50 金币');
define('TZ_OK_2', '确定');
define('TZ_OPEN_FORUM_FOR_THE_FOLLOWING_PLAYE', '向以下玩家开放论坛');
define('TZ_OPEN_FOR_MORE_ALLIANCES', '向更多联盟开放');
define('TZ_ORDER', '顺序：');
define('TZ_OTHER', '其他');
define('TZ_OWNER', '拥有者：');
define('TZ_PAY_SECURELY_WITH_PAYPAL', '使用 PayPal 安全付款。');
define('TZ_PLAYERS_BROUGHT_IN', '已带来的玩家');
define('TZ_POST_NEW_THREAD', '发布新主题');
define('TZ_PREVIEW', '预览');
define('TZ_PREVIEW_2', '预览');
define('TZ_PROGRESS_OF_YOUR_INVITED_FRIENDS', '您邀请的好友的进度');
define('TZ_QUIT_ALLIANCE', '退出联盟');
define('TZ_REGISTER_FOR_THE_GAME', '注册游戏');
define('TZ_REGISTRATION', '注册');
define('TZ_SENT', '已发送：');
define('TZ_SMILIES', '表情');
define('TZ_SMILIES_2', '表情');
define('TZ_STONEMASON_S_LODGE', '石匠铺');
define('TZ_TAG', '标签：');
define('TZ_TARGET_VILLAGE', '目标村庄：');
define('TZ_TASK_10_CRANNY', '任务 10：藏匿处');
define('TZ_TASK_11_TO_TWO', '任务 11：升至二级。');
define('TZ_TASK_12_INSTRUCTIONS', '任务 12：说明');
define('TZ_TASK_13_MAIN_BUILDING', '任务 13：主建筑');
define('TZ_TASK_14_ADVANCED', '任务 14：进阶！');
define('TZ_TASK_16_ECONOMY', '任务 16：经济');
define('TZ_TASK_16_MILITARY', '任务 16：军事');
define('TZ_TASK_17_BARRACKS', '任务 17：兵营');
define('TZ_TASK_17_WAREHOUSE', '任务 17：仓库');
define('TZ_TASK_18_MARKETPLACE', '任务 18：市场。');
define('TZ_TASK_18_TRAIN', '任务 18：训练。');
define('TZ_TASK_19_EVERYTHING_TO_2', '任务 19：全部升至 2 级。');
define('TZ_TASK_20_ALLIANCE', '任务 20：联盟。');
define('TZ_TASK_21_MAIN_BUILDING_TO_LEVEL_5', '任务 21：主建筑升至 5 级');
define('TZ_TASK_22_GRANARY_TO_LEVEL_3', '任务 22：粮仓升至 3 级。');
define('TZ_TASK_23_WAREHOUSE_TO_LEVEL_7', '任务 23：仓库升至 7 级。');
define('TZ_TASK_24_ALL_TO_FIVE', '任务 24：全部升至五级！');
define('TZ_TASK_25_PALACE_OR_RESIDENCE', '任务 25：宫殿还是官邸？');
define('TZ_TASK_26_3_SETTLERS', '任务 26：3 个殖民者。');
define('TZ_TASK_27_NEW_VILLAGE', '任务 27：新村庄。');
define('TZ_TASK_3_YOUR_VILLAGE_S_NAME', '任务 3：您的村庄名称');
define('TZ_TASK_9_DOVE_OF_PEACE', '任务 9：和平鸽');
define('TZ_TERMS', '条款');
define('TZ_THE_ALLIANCE', '该联盟');
define('TZ_THE_LARGEST_ALLIANCES', '最大的联盟');
define('TZ_THE_USER', '该用户');
define('TZ_THREAD', '主题');
define('TZ_TOP_10', '前 10 名');
define('TZ_TOTAL', '总计');
define('TZ_TOWNHALL', '市政厅');
define('TZ_TRAVIAN', 'Travian');
define('TZ_TRAVIANX', 'TravianX');
define('TZ_TRAVIANZ', 'TravianZ');
define('TZ_TRAVIAN_GAMES', 'Travian Games');
define('TZ_UNDERLINE', '下划线');
define('TZ_UNDERLINED', '下划线');
define('TZ_UNKNOWN', '未知');
define('TZ_UNTIL_THE_NEXT_LEVEL', '直到下一级');
define('TZ_USER_ID', '用户 ID');
define('TZ_VILLAGE', '村庄：');
define('TZ_VILLAGE_OVERVIEW', '村庄概览');
define('TZ_WAIT_INSTANT', '等待：即时');
define('TZ_WARNING', '警告：');
define('TZ_WOOD', '木材');
define('TZ_YOUR_PERSONAL_REF_LINK', '您的个人推荐链接：');
define('TZ_YOU_CAN_T_USE_THE_VALUES', '您不能使用这些值');
define('TZ_YOU_HAVE_NOT_BROUGHT_IN_ANY_NEW_PL', '您还没有带来任何新玩家。');

// ===== i18n etape 2 (lot suivant) =====
define('TZ_ACCOUNT_IS_ADMIN_OR_MH', '账户为管理员或多猎手');
define('TZ_ACCOUNT_IS_NOT_SCHEDULED_FOR_DELET', '账户未安排删除');
define('TZ_ACCOUNT_STATEMENT', '账户对账单');
define('TZ_ACTIVATE_VACATION_MODE', '启用度假模式');
define('TZ_ADD_RAID', '添加掠夺');
define('TZ_ADD_SLOT', '添加槽位');
define('TZ_ADVANTAGES', '优势');
define('TZ_AFTER_PAYMENT_YOU_WILL_BE_CREDITED', '付款后将自动到账。');
define('TZ_AGRESOR', '进攻方');
define('TZ_ALLIANCE_DIPLOMACY', '联盟外交');
define('TZ_ALLIANCE_EVENTS', '联盟事件');
define('TZ_ALLIANCE_FORUM', '联盟论坛');
define('TZ_ALLIANCE_MEMBERS', '联盟成员。');
define('TZ_ALLY_CHAT', '联盟聊天');
define('TZ_AM', '上午');
define('TZ_AND_LATER_YOUR_VILLAGE_COULD_LOOK', '……稍后您的村庄可能会变成那样。');
define('TZ_AND_QUIT_THE_ALLIANCE_AFTERWARDS', '之后退出联盟。');
define('TZ_ASSIGN_RIGHTS', '分配权限');
define('TZ_ATTENTION_USE_ONLY_TRUSTWORTHY_GRA', '注意！只使用可信的图形包');
define('TZ_AUTHOR', '作者');
define('TZ_BEGINNERS_PROT', '新手保护');
define('TZ_BEST_PLAYER', '最佳玩家');
define('TZ_BUILDING_SITE', '建筑空地');
define('TZ_BUILD_A_PALACE_OR_RESIDENCE_TO_LEV', '将宫殿或官邸建至 10 级。');
define('TZ_BUILD_CROPPER', '建造高产粮村');
define('TZ_BUY_IT_IN_THE_GOLD_SHOP', '在金币商店购买');
define('TZ_CELEBRATION_STILL_NEEDS', '庆典还需要：');
define('TZ_CENTRE', '中心：');
define('TZ_CHANGE_NAME', '更改名称');
define('TZ_CHANGE_YOUR_VILLAGE_S_NAME_TO_SOME', '给您的村庄起个好听的名字。');
define('TZ_CHINESE', '中文');
define('TZ_CLAY_25_5_GOLD', '黏土 +25%（5 金币）');
define('TZ_CLOSED_FORUM', '封闭论坛');
define('TZ_CLOSE_ADRESSBOOK', '关闭通讯录');
define('TZ_COMBAT_SIMULATOR', '战斗模拟器');
define('TZ_COMPLETE_DEMOLITION_10', '完全拆除（10');
define('TZ_CONFEDERATION_FORUM', '联邦论坛');
define('TZ_CONFIRM_WITH_PASSWORD', '用密码确认：');
define('TZ_CONSTRUCT_A_CRANNY', '建造藏匿处。');
define('TZ_CONSTRUCT_A_GRANARY', '建造粮仓。');
define('TZ_CONSTRUCT_A_RALLY_POINT', '建造集结点。');
define('TZ_CONSTRUCT_A_WOODCUTTER', '建造伐木场。');
define('TZ_CONSTRUCT_BARRACKS', '建造兵营。');
define('TZ_CONSTRUCT_WAREHOUSE', '建造仓库。');
define('TZ_CP_DAY', '文化点/天');
define('TZ_CROP_25_5_GOLD', '粮食 +25%（5 金币）');
define('TZ_DATE_AND_TIME', '日期和时间');
define('TZ_DECLARE_WAR', '宣战');
define('TZ_DEFAULT', '默认：');
define('TZ_DELETE_ACCOUNT', '删除账户？');
define('TZ_DIFFERENT_EMAIL_ADDRESS', '其他电子邮件地址');
define('TZ_DOWNLOAD_FROM', '下载自');
define('TZ_DO_I_NEED_PLUS_TO_USE_OTHER_FEATUR', '我需要 Plus 才能使用其他功能吗？');
define('TZ_EARN_GOLD', '赚取金币');
define('TZ_EDIT_ANSWER', '编辑回答');
define('TZ_EDIT_ANSWER_2', '编辑回答');
define('TZ_EDIT_FORUM', '编辑论坛');
define('TZ_EDIT_SLOT', '编辑槽位');
define('TZ_EDIT_TOPIC', '编辑主题');
define('TZ_ENDS_ON', '结束于');
define('TZ_ENGLISH', '英语');
define('TZ_ENTER_HOW_MUCH_LUMBER_THE_BARRACKS', '输入兵营消耗的木材数量');
define('TZ_EU_DD_MM_YY_24H', '欧盟 (dd.mm.yy 24h)');
define('TZ_EXAMPLE', '示例：');
define('TZ_EXISTING_RELATIONSHIPS', '现有关系');
define('TZ_EXTEND_ALL_RESOURCE_TILES_TO_LEVEL', '将所有资源田升至 1 级。');
define('TZ_EXTEND_ALL_RESOURCE_TILES_TO_LEVEL_2', '将所有资源田升至 2 级。');
define('TZ_EXTEND_ONE_CLAY_PIT', '升级一块黏土坑。');
define('TZ_EXTEND_ONE_CROPLAND', '升级一块农田。');
define('TZ_EXTEND_ONE_IRON_MINE', '升级一座铁矿。');
define('TZ_EXTEND_ONE_OF_EACH_RESOURCE_TILE_T', '将每种资源田各一块升至 2 级。');
define('TZ_EXTEND_YOUR_MAIN_BUILDING_TO_LEVEL', '将主建筑升至 3 级。');
define('TZ_FINISH', '完成');
define('TZ_FOLLOWING_CAUSES_ARE_POSSIBLE', '可能的原因如下：');
define('TZ_FOLLOW_THIS_LINK_TO', '点击此链接以');
define('TZ_FOREIGN_OFFERS', '外部报价');
define('TZ_FORUM_TYPE', '论坛类型');
define('TZ_FOUND_A_NEW_VILLAGE', '建立一个新村庄。');
define('TZ_FREE', '免费！');
define('TZ_FRENCH', '法语');
define('TZ_FRIEND_EMAIL_COM', 'friend@email.com');
define('TZ_GAME_LANGUAGE', '游戏语言');
define('TZ_GITHUB', 'Github');
define('TZ_GRAPHIC_PACK_FOUND', '已找到图形包。');
define('TZ_GRAPHIC_PACK_SETTINGS', '图形包设置');
define('TZ_GREAT_STABLES', '大马厩');
define('TZ_HERE', '这里');
define('TZ_HERE_YOU_CAN_KICK_THE_PLAYERS_FROM', '您可以在此踢出联盟中的玩家。');
define('TZ_HERE_YOU_FIND_YOUR_RESOURCE_FIELDS', '您可以在此找到您的资源田');
define('TZ_HINT', '提示');
define('TZ_HOW_DO_I_GET_GOLD', '如何获得金币？');
define('TZ_INACTIVE_DURING_VACATION', '度假期间不活跃');
define('TZ_INFORMATION_ON_HAPPENINGS_IN_YOUR', '您村庄中发生事件的信息');
define('TZ_INITIATE_PAYMENT_BY_PAYPAL', '通过 PayPal 发起付款');
define('TZ_INVITATIONS', '邀请：');
define('TZ_INVITE_A_PLAYER_INTO_THE_ALLIANCE', '邀请玩家加入联盟');
define('TZ_INVITE_BY_E_MAIL_OR_SHARE_YOUR_REF', '通过电子邮件邀请或分享您的推荐链接。');
define('TZ_IN_DESCRIPTION', '在描述中。');
define('TZ_IN_THE_VILLAGE_YOU_CAN_BUILD_BUILD', '在村庄中您可以建造建筑');
define('TZ_IRON_25_5_GOLD', '铁 +25%（5 金币）');
define('TZ_ISO_YY_MM_DD_24H', 'ISO (yy/mm/dd 24h)');
define('TZ_ITALIAN', '意大利语');
define('TZ_I_ACTIVATED_PLUS_BUT_PRODUCTION_DI', '我激活了 Plus，但产量没有增加。');
define('TZ_JOIN_AN_ALLIANCE', '加入联盟');
define('TZ_JOIN_AN_ALLIANCE_OR_FOUND_ONE_ON_Y', '加入联盟或自己创建一个。');
define('TZ_JUL', '7月');
define('TZ_JUN', '6月');
define('TZ_KICK_ALL_MEMBERS', '踢出所有成员');
define('TZ_KICK_PLAYER', '踢出玩家：');
define('TZ_LANGUAGE_SETTINGS', '语言设置');
define('TZ_LAST_POST', '最新帖子');
define('TZ_LAST_RAID', '最近掠夺');
define('TZ_LINKS', '链接：');
define('TZ_LINK_TO_THE_FORUM', '论坛链接');
define('TZ_LOG_IN', '登录');
define('TZ_LUMBER_25_5_GOLD', '木材 +25%（5 金币）');
define('TZ_MAINTENANCE_OFF', '维护已关闭');
define('TZ_MAINTENANCE_ON', '维护已开启');
define('TZ_MAJOR_CHANGES', '主要更改：');
define('TZ_MAP_2', '地图：');
define('TZ_MAXIMUM_VACATION', '最长度假：');
define('TZ_MESSAGES', '消息：');
define('TZ_MESSAGE_3', '消息');
define('TZ_MILITARY_EVENTS', '军事事件');
define('TZ_MINIMUM_VACATION', '最短度假：');
define('TZ_MINOR_CHANGES', '次要更改：');
define('TZ_MISCELLANEOUS', '杂项');
define('TZ_MORE_GRAPHIC_PACKS', '更多图形包');
define('TZ_MORE_INFO', '更多信息：');
define('TZ_MOVE_TOPIC', '移动主题');
define('TZ_MULTIHUNTER', '多猎手：');
define('TZ_NEW_FORUM', '新论坛');
define('TZ_NONE_OF_THE_PACKAGES_ARE_REFUNDABL', '所有套餐均不可退款！');
define('TZ_NOT_ENOUGH_RESOURCE', '资源不足');
define('TZ_NO_MARKETPLACE_ACTIVITY', '无市场活动');
define('TZ_NO_OWNERSHIP_OF_AN_ARTIFACT_VILLAG', '未拥有神器村庄');
define('TZ_NO_OWNERSHIP_OF_A_WONDER_OF_THE_WO', '未拥有世界奇迹村庄');
define('TZ_NO_REINFORCING_TROOPS_SENT_RECEIVE', '无增援部队派出/接收');
define('TZ_NO_REPORTS_FOR_TRANSFERS_FROM_FORE', '无来自外部村庄转移的报告。');
define('TZ_NO_REPORTS_FOR_TRANSFERS_TO_FOREIG', '无发往外部村庄转移的报告。');
define('TZ_NO_REPORTS_FOR_TRANSFERS_TO_OWN_VI', '无发往自己村庄转移的报告。');
define('TZ_N_14_DAYS', '14 天');
define('TZ_N_1_1_TRADE_WITH_THE_NPC_MERCHANT', '与 NPC 商人 1:1 交易');
define('TZ_N_1_5_YOUR_VILLAGE', '(1/5) 您的村庄');
define('TZ_N_1_CHOOSE_A_RESOURCE_FIELD', '1. 选择一块资源田');
define('TZ_N_1_CHOOSE_BUILDING_SITE', '1. 选择建筑空地');
define('TZ_N_2_5_RESOURCES', '(2/5) 资源');
define('TZ_N_2_CONSTRUCT_A_BUILDING', '2. 建造一座建筑');
define('TZ_N_2_DAYS', '2 天');
define('TZ_N_2_EXTEND_THE_RESOURCE_FIELD', '2. 升级资源田');
define('TZ_N_3_5_BUILDINGS', '(3/5) 建筑');
define('TZ_N_4_5_NEIGHBOURS', '(4/5) 邻居');
define('TZ_N_5_5_NAVIGATION', '(5/5) 导航');
define('TZ_OFFER_A_CONFEDERATION', '提议结成联邦');
define('TZ_OFFER_NON_AGGRESSION_PACT', '提议互不侵犯条约');
define('TZ_OK_3', '确定');
define('TZ_ONLINE_USERS', '在线用户');
define('TZ_OPTION_1', '选项 1：');
define('TZ_OPTION_2', '选项 2：');
define('TZ_OPTION_3', '选项 3：');
define('TZ_OPTION_4', '选项 4：');
define('TZ_OPTION_5', '选项 5：');
define('TZ_OPTION_6', '选项 6：');
define('TZ_OPTION_7', '选项 7：');
define('TZ_OPTION_8', '选项 8：');
define('TZ_ORDERED_PACKAGE', '已订购套餐');
define('TZ_OR_ASK_THE_SERVER_OWNER', '或询问服务器所有者。');
define('TZ_OVERVIEW', '概览：');
define('TZ_OWN_TEXT', '自定义文本：');
define('TZ_PALACE_RESIDENCE', '宫殿/官邸');
define('TZ_PASSWORD', '密码：');
define('TZ_PAYMENT_ACCOUNT', '付款账户');
define('TZ_PAYPAL', 'PayPal');
define('TZ_PAYPAL_PACKAGE_A', 'PayPal – 套餐 A');
define('TZ_PAYPAL_PACKAGE_B', 'PayPal – 套餐 B');
define('TZ_PAYPAL_PACKAGE_C', 'PayPal – 套餐 C');
define('TZ_PAYPAL_PACKAGE_D', 'PayPal – 套餐 D');
define('TZ_PAYPAL_PACKAGE_E', 'PayPal – 套餐 E');
define('TZ_PLAY_NO_TASKS', '不进行任务。');
define('TZ_PLEASE_BUILD_A_MARKETPLACE', '请建造一座市场。');
define('TZ_PLUS_FUNCTIONS', 'Plus 功能');
define('TZ_PM', '下午');
define('TZ_POP', '人口');
define('TZ_POSITION', '职位：');
define('TZ_PRODUCTION_CLAY', '产量：黏土');
define('TZ_PRODUCTION_CROP', '产量：粮食');
define('TZ_PRODUCTION_IRON', '产量：铁');
define('TZ_PRODUCTION_LUMBER', '产量：木材');
define('TZ_PUBLIC_FORUM', '公开论坛');
define('TZ_RAGEZONE_COM', 'RageZone.com');
define('TZ_RANKING_OF_ALL_PLAYERS', '所有玩家排名');
define('TZ_RATIO', '比率');
define('TZ_READ_YOUR_NEW_MESSAGE', '阅读您的新消息。');
define('TZ_REGISTERED', '已注册');
define('TZ_REGISTERED_PLAYERS', '已注册玩家');
define('TZ_RELEASED_BY_TRAVIANZ_TEAM', '发布者：TravianZ 团队');
define('TZ_RELEASE_BY_TRAVIANZ', '[发布者：TravianZ]');
define('TZ_REPLIES', '回复');
define('TZ_REPORTS', '报告：');
define('TZ_REQUIREMENTS', '要求');
define('TZ_ROMANIAN', '罗马尼亚语');
define('TZ_SCOUT_DEFENCES_AND_TROOPS', '侦察防御和部队');
define('TZ_SCOUT_RESOURCES_AND_TROOPS', '侦察资源和部队');
define('TZ_SCRIPT_PRICE', '脚本价格：');
define('TZ_SELECT_ALL', '全选');
define('TZ_SELECT_REWARD', '选择奖励……');
define('TZ_SELECT_REWARD_2', '选择奖励：');
define('TZ_SEND_200_CROP_TO_THE_TASKMASTER', '向任务主管发送 200 粮食。');
define('TZ_SEND_AND_RECEIVE_MESSAGES', '发送和接收消息');
define('TZ_SEND_UNITS_BACK', '撤回部队');
define('TZ_SERVER_START', '服务器开始');
define('TZ_SHOW_THE_LARGE_MAP_IN_AN_EXTRA_WIN', '在额外窗口中显示大地图。');
define('TZ_SIZE_IN_MB', '大小（MB）');
define('TZ_SLOTS', '槽位');
define('TZ_START_RAID', '开始掠夺');
define('TZ_STATISTICS', '统计：');
define('TZ_SUPPORT', '支持：');
define('TZ_SUPPORT_AND_MULTIHUNTER', '支持与多猎手');
define('TZ_SURVEY', '调查');
define('TZ_TARIFFS', '资费');
define('TZ_TASK_7_HUGE_ARMY', '任务 7：庞大军队！');
define('TZ_TASK_8_EVERYTHING_TO_1', '任务 8：全部升至 1 级。');
define('TZ_THANK_YOU_FOR_USING_OUR_VERSION', '感谢您使用我们的版本！');
define('TZ_THERE_ARE_NO_INCOMING_TROOPS', '没有正在到达的部队');
define('TZ_THERE_ARE_NO_OUTGOING_TROOPS', '没有正在派出的部队');
define('TZ_THE_BEST_ALLIANCES_DEF', '最佳联盟（防御）');
define('TZ_THE_BEST_ALLIANCES_OFF', '最佳联盟（进攻）');
define('TZ_THE_BUILDING_WAS_COMPLETELY_DEMOLI', '该建筑已花费 10 金币完全拆除！');
define('TZ_THE_EMAIL_ACCOUNT_S_STORAGE_LIMIT', '电子邮件账户的存储上限已满');
define('TZ_THE_EMAIL_HAS_BEEN_MOVED_TO_THE_SP', '电子邮件已被移至垃圾邮件文件夹');
define('TZ_THE_EMAIL_WILL_BE_SENT_TO_FOLLOWIN', '电子邮件将发送至以下地址：');
define('TZ_THE_E_MAIL_ADDRESS_OF_THE_NEW_OWNE', '新所有者的电子邮件地址。');
define('TZ_THE_GAME_WORLD_ON_WHICH_THE_ACCOUN', '账户所在的游戏世界');
define('TZ_THE_HERO', '英雄');
define('TZ_THE_LARGEST_GAULS', '最强高卢人');
define('TZ_THE_LARGEST_PLAYERS', '最强玩家');
define('TZ_THE_LARGEST_ROMANS', '最强罗马人');
define('TZ_THE_LARGEST_TEUTONS', '最强条顿人');
define('TZ_THE_LARGEST_VILLAGES', '最大的村庄');
define('TZ_THE_MOST_EXPERIENCED_HEROES', '最有经验的英雄');
define('TZ_THE_MOST_SUCCESSFUL_ATTACKERS', '最成功的进攻者');
define('TZ_THE_MOST_SUCCESSFUL_DEFENDERS', '最成功的防御者');
define('TZ_THE_MULTIHUNTERS_ARE_RESPONSIBLE_F', '多猎手负责监督遵守');
define('TZ_THE_NAVIGATION_BAR', '导航栏');
define('TZ_THE_NICKNAME_OF_THE_ACCOUNT', '账户的昵称');
define('TZ_THE_PATH', '路径');
define('TZ_THE_VILLAGE', '村庄');
define('TZ_THIS_FEATURE_IS_NOT_INCLUDED_IN_TH', '此功能不包含在金币俱乐部中！');
define('TZ_THIS_IS_HOW_YOU_START', '您可以这样开始……');
define('TZ_THREADS', '主题');
define('TZ_TIME_PREFERENCE', '时间偏好');
define('TZ_TIME_ZONES', '时区');
define('TZ_TIP', '提示');
define('TZ_TOP_10_ALLIANCES', '联盟前 10 名');
define('TZ_TOP_10_PLAYERS', '玩家前 10 名');
define('TZ_TOTAL_POPULATION', '总人口');
define('TZ_TOTAL_VILLAGES', '村庄总数');
define('TZ_TO_THE_FIRST_TASK', '前往第一个任务。');
define('TZ_TO_THE_REGISTRATION', '前往注册');
define('TZ_TRAIN_3_SETTLERS', '训练 3 个殖民者。');
...
define('TZ_TRIBES', '部族');
define('TZ_TYPOS_IN_THE_EMAIL_ADDRESS', '电子邮件地址有拼写错误');
define('TZ_UK_DD_MM_YY_12H', '英国 (dd/mm/yy 12h)');
define('TZ_UPGRADE_ALL_RESOURCES_TILES_TO_LEV', '将所有资源田升至 5 级。');
define('TZ_UPGRADE_YOUR_GRANARY_TO_LEVEL_3', '将粮仓升至 3 级。');
define('TZ_UPGRADE_YOUR_MAIN_BUILDING_TO_LEVE', '将主建筑升至 5 级。');
define('TZ_UPGRADE_YOUR_WAREHOUSE_TO_LEVEL_7', '将仓库升至 7 级。');
define('TZ_USE', '使用');
define('TZ_USED_FOR_RALLY_POINT_AND_MARKETPLA', '用于集结点和市场：');
define('TZ_USERNAME', '用户名');
define('TZ_USER_DEFINED_GRAPHIC_PACK', '自定义图形包');
define('TZ_USE_IT_FOR_PLUS_OR_ANY_ADVANTAGE', '。可用于 Plus 或任何优势。');
define('TZ_US_MM_DD_YY_12H', '美国 (mm/dd/yy 12h)');
...
define('TZ_VERSION', '版本：');
define('TZ_VILLAGE_EXP', '村庄扩张');
define('TZ_VILLAGE_YOU_GET', '村庄，您将获得');
define('TZ_VILLAGE_YOU_WILL_BE_CREDITED_WITH', '村庄，您将获得');
define('TZ_VIP_ACCOUNT_10_GOLD_7_DAYS', 'VIP 账户（10 金币 – 7 天）');
define('TZ_VISIT', '访问：');
define('TZ_VOTE', '投票');
define('TZ_WAIT_24H', '等待：24 小时');
define('TZ_WAIT_INSTANT_AFTER_IPN', '等待：IPN 后即时');
define('TZ_WARNING_CATAPULT_WILL', '警告：投石车将');
define('TZ_WE_STRIVE_TO_ENSURE_SPEEDY_PROCESS', '我们力求快速处理！');
define('TZ_WHY_CAN_T_I_FINISH_SOME_BUILDINGS', '为什么有些建筑不能用金币完成？');
define('TZ_WILL_BE_ATTACKED_BY_CATAPULT_S', '（将被投石车攻击）');
define('TZ_WILL_SPAWN_IN', '将出现于：');
define('TZ_WOODCUTTER_INSTANTLY_COMPLETED', '伐木场已立即完成。');
define('TZ_WORLD_STATS', '世界统计');
define('TZ_WRITE_THE_CODE', '输入代码');
define('TZ_WRONG_DOMAIN_THERE_IS_E_G_NO_AOL_D', '域名错误：例如没有 @aol.de，只有 @aol.com');
define('TZ_YOUR_ACCOUNT_HAS_BEEN_SUCCESSFULLY', '您的账户已成功激活。');
define('TZ_YOUR_VILLAGE_AND_YOUR_NEIGHBOURS', '您的村庄和邻居');
define('TZ_YOU_CAN_UNDO_THE_REGISTRATION_AND', '您可以撤销注册并使用以下方式重新注册');
define('TZ_YOU_CAN_USE_THIS_GOLD_FOR_PLUS_OR', '。您可以将此金币用于 Plus 或任何金币优势。');

// ===== i18n etape 2 (lot suivant) =====
define('TZ_ACCOUNT_OR_INCREASE_YOUR_RESOURCE', '-账户或提高您的资源产量。为此请点击');
define('TZ_ADDITIONALLY_THE_TRAVIAN_TEAM_WILL', '此外，Travian 团队不会向账户所有者以外的任何人提供有关封禁的信息。');
define('TZ_ADVERTISEMENT_OF_ANY_KIND_THAT_HAS', '未经 Travian 团队许可的任何形式广告均不允许。');
define('TZ_AFTERWARDS_BOTH_PARTIES_MUST_REQUE', '之后，双方必须通过密码找回功能申请其新账户的密码。');
define('TZ_AFTER_TAKING_CARE_OF_YOUR_RESOURCE', '在保证资源供应后，您可以开始扩张您的村庄。');
define('TZ_ANY_SALES_OR_PURCHASES_CONCERNING', '任何涉及真实货币、关于账户、单位、村庄、资源、服务或 Travian 任何其他方面的买卖均不允许。出售 Travian 账户以及与拍卖网站或其他金钱交易相关的任何间接转让（即使作为礼物）均不允许。');
define('TZ_AS_A_LEADER_YOU_CAN_ONLY_CHANGE_YO', '作为领袖，您只能更改您的头衔。您的权限保持最高。');
define('TZ_A_SITTER_CAN_LOG_INTO_YOUR_ACCOUNT', '代理人可以使用您的名字和他/她的密码登录您的账户。您最多可以有两名代理人。');
define('TZ_A_WAREHOUSE_AND_A_GRANARY_ENABLE_Y', '仓库和粮仓让您能储存更多资源。藏匿处可保护您的资源不被敌方掠夺者偷走。');
define('TZ_BECAUSE_YOU_ARE_THE_ALLIANCE_FOUND', '由于您是联盟创始人，离开前需要选择一位接替的创始人。');
define('TZ_BEFORE_YOU_EXPAND_YOUR_VILLAGE_S_B', '在扩建村庄建筑之前，您应该开发一些资源田以增加资源供应。');
define('TZ_BLACKMAILING_PLAYERS_IN_A_WAY_THAT', '以违反 Travian 任何规则（依据一般条款与条件）的方式勒索玩家。');
define('TZ_COMPLETE_CONSTRUCTION_ORDERS_AND_R', '立即完成此村庄的建造订单和研究');
define('TZ_DISPLAYING_BATTLE_REPORTS_OR_MESSA', '未经双方同意公开展示战报或消息。');
define('TZ_EACH_PLAYER_MAY_ONLY_OWN_AND_PLAY', '每位玩家每个服务器只能拥有并使用一个账户。');
define('TZ_ENGLISH_IS_THE_ONLY_LANGUAGE_TOLER', '消息和描述中只允许使用英语。');
define('TZ_FOLLOWING_BEHAVIOR_IS_PUNISHABLE_A', '以下行为将受到处罚，适用于所有描述、账户名、联盟名、村庄名和消息：');
define('TZ_HERE_YOU_CAN_CHANGE_TRAVIAN_S_DISP', '您可以在此更改 Travian 显示的时间以符合您的时区。');
define('TZ_HERE_YOU_CAN_HAVE_A_LOOK_AT_YOUR_V', '您可以在此查看您村庄的周边区域和邻居');
define('TZ_HOWEVER_IT_IS_PERMISSIBLE_TO_TRANS', '但是，允许将账户密码转交给在不同游戏世界游玩（或完全不游玩）的一人或多人，以便共同使用一个账户。');
define('TZ_IF_INDIVIDUAL_REGULATIONS_OF_THIS', '如果本规则中的个别条款被证明在任何方面无效，不影响本规则其余条款的有效性。管理员承诺尽快用新条款替换无效条款。');
define('TZ_IF_THERE_IS_AN_OFFENCE_AGAINST_THE', '如果违反这些游戏规则，多猎手以及必要时管理员将封禁相关账户并决定适当的处罚。处罚总是会超过违反规则所得的收益。');
define('TZ_IF_YOUR_ALLIANCE_WANTS_TO_USE_AN_E', '如果您的联盟想使用外部论坛，可以在此输入网址。');
define('TZ_IMPERSONATING_OFFICIALS_OR_OFFICIA', '以任何方式假冒官方人员或官方职位均属违法。');
define('TZ_INCITING_MANIPULATING_ENCOURAGING', '煽动、操纵、鼓励、协助或与他人串通违反任何 Travian 规则均不允许。这些规则无一例外地适用于将要删除或正在删除账户的玩家。');
define('TZ_INTO_YOUR_PROFILE_BY_ADDING_IT_TO', '添加到两个描述栏之一，即可加入您的个人资料。');
define('TZ_IN_ORDER_TO_ACTIVATE_YOUR_ACCOUNT', '要激活您的账户，请输入代码或点击电子邮件中的链接。');
define('TZ_IN_ORDER_TO_PLAY_TRAVIAN_YOU_NEED', '要游玩 Travian，您需要一个有效的电子邮件地址以接收激活码。在特殊情况下，此邮件可能无法送达。');
define('TZ_IN_ORDER_TO_QUIT_THE_ALLIANCE_YOU', '出于安全原因，退出联盟时您必须再次输入密码。');
define('TZ_IN_ORDER_TO_SWITCH_AN_ACCOUNT_WITH', '若要在同一游戏世界与他人互换账户，双方必须从该账户当前注册的电子邮件地址向 admin@travian.com 发送电子邮件。邮件须包含以下信息：');
define('TZ_IN_THE_BEGINNING_YOUR_SMALL_VILLAG', '一开始，您的小村庄只有一座建筑。');
define('TZ_IN_TRAVIAN_YOU_ARE_NOT_ALONE_YOU_I', '在 Travian 中您并不孤单；您会与 Travian 世界中成千上万的其他玩家互动。');
define('TZ_IT_S_PART_OF_DIPLOMATIC_ETIQUETTE', '在发送提议之前先与另一个联盟沟通是外交礼节的一部分。');
define('TZ_MULTIACCOUNTS_ON_THE_SPEED_SERVER', '极速服务器上的多账户以及人口少于 100 的多账户可被立即删除，恕不预先警告。');
define('TZ_NOW_YOU_HAVE_FULFILLED_ALL_PREREQU', '现在您已满足建造市场所需的所有前置条件。');
define('TZ_NOW_YOU_KNOW_EVERYTHING_IMPORTANT', '现在您已了解关于 Travian 的所有重要内容。注册后即可开始游戏！');
define('TZ_NO_EVERY_GOLD_FEATURE_WORKS_STANDA', '不需要。只要您有足够的金币，每项金币功能都可独立使用。');
define('TZ_NO_REAL_WORLD_POLITICS_ARE_ALLOWED', '名称、消息和描述中不允许出现现实世界政治内容。');
define('TZ_PARTICIPATION_IN_ABUSIVE_DEFAMATOR', '参与辱骂、诽谤、性别歧视、种族主义或亵渎性言语；贬低任何宗教、种族、国家、性别、年龄群体或性取向；以现实生活中的行为威胁他人。');
define('TZ_PLAYERS_MAY_TALK_TO_THE_MULTIHUNTE', '玩家可通过游戏内消息（IGM）或电子邮件与封禁他们的多猎手或管理员沟通。封禁、处罚或删除不得在公开场合（如聊天或论坛）讨论。申诉必须用英语书写。');
define('TZ_PLEASE_ENTER_YOUR_OLD_AND_YOUR_NEW', '请输入您的旧电子邮件地址和新电子邮件地址。然后您将在两个地址收到一段代码，需在此处输入。');
define('TZ_PLUS_DOES_NOT_INCLUDE_PRODUCTION_B', 'Plus 不包含产量加成。您必须分别为每种资源购买 +25%，在');
define('TZ_PROGRAM_ERRORS_ALSO_CALLED_BUGS_MA', '程序错误（也称 bug）不得用于谋取私利。滥用可能导致账户受罚。');
define('TZ_RESIDENCE_PALACE_AND_WORLD_WONDER', '出于游戏性原因，官邸、宫殿和世界奇迹村庄被排除在外。');
define('TZ_RESOURCES_BUILDINGS_VILLAGES_OR_TR', '暂停期间损失的资源、建筑、村庄或部队不计为处罚，且不会由 Travian 团队补偿。任何玩家无权就因暂停而损失的 Plus/金币时间索要赔付或补偿。');
define('TZ_SHOOT_WITH_A_NORMAL_ATTACK_THEY_DO', '在普通攻击时射击（掠夺时不射击！）');
define('TZ_SOMETIMES_THE_EMAIL_IS_MOVED_TO_TH', '有时电子邮件会被移至垃圾邮件文件夹。如需进一步帮助请点击');
define('TZ_THERE_ARE_FOUR_DIFFERENT_TYPES_OF', 'Travian 中有四种不同的资源：木材、黏土、铁和粮食。');
define('TZ_THERE_IS_NO_COMPENSATION_FOR_DAMAG', '对于代理人造成的损害不予补偿。账户所有者对其账户所选代理人的行为负全部责任。如果账户代理人不遵守这些规则及 Travian 的一般条款与条件，账户所有者和代理人均可能被追责并受罚。');
define('TZ_THERE_IS_NO_COMPENSATION_FOR_DAMAG_2', '对于知晓账户密码者造成的损害不予补偿。获得密码的人须遵守 Travian 规则及一般条款与条件。');
define('TZ_THERE_IS_NO_SPECIAL_TREATMENT_FOR', '在游戏规则方面，对 Travian Plus/金币用户没有特殊待遇，无论是处理案件所需时间还是处罚。');
define('TZ_THE_E_MAIL_ADDRESS_USED_FOR_THE_RE', '用于注册账户的电子邮件地址必须由注册该账户的人员个人独占控制。无论存在任何其他个人或联盟协议，拥有该账户当前注册电子邮件地址的人被视为账户所有者。账户所有者对该账户的所有行为负全部责任。');
define('TZ_THE_FOLLOWING_SET_OF_RULES_ARE_IN', '以下规则与 Travian 的一般条款与条件相结合。您应熟悉一般条款与条件，以确认哪些被允许、哪些被禁止，尤其是在账户因违反规则被封禁的情况下。');
define('TZ_THE_GAME_MUST_BE_PLAYED_WITH_AN_UN', '游戏必须使用未经修改的网络浏览器游玩。使用使账户操作自动化的脚本或机器人违反规则。');
define('TZ_THE_OWNER_OF_AN_ACCOUNT_MAY_NOT_TR', '账户所有者不得将账户密码转交给在同一游戏世界（服务器）游玩的任何人。此外，故意在同一游戏世界选择与他人相同的密码属违法；任何此类行为均被视为多账户，如本规则所定义。');
define('TZ_THE_PLAYERS_IN_YOUR_SURROUNDING_AR', '您周边区域的玩家对您最为重要。借助地图，您可以很好地了解他们是谁。');
define('TZ_THE_REGISTRATION_WAS_SUCCESSFUL_IN', '注册成功。接下来几分钟内您将收到一封含访问信息的电子邮件。');
define('TZ_THE_SUPPORT_IS_A_GROUP_OF_EXPERIEN', '客服是一群经验丰富的玩家，他们将乐意回答您的问题。');
define('TZ_THE_TRAVIAN_TEAM_RESERVES_THE_RIGH', 'Travian 团队保留随时更改规则的权利。');
define('TZ_TO_BRING_IN_NEW_PLAYERS_INVITE_THE', '要带来新玩家，请通过电子邮件邀请他们或分享您的推荐链接。');
define('TZ_VACATION_MODE_CANNOT_BE_ACTIVATED', '无法启用度假模式 – 未满足条件');
define('TZ_WE_WILL_SHOW_YOU_HOW_TO_EXPAND_YOU', '我们将在下一页向您展示如何扩张您的村庄，使其成为一座强大而繁荣的城市。');
define('TZ_YOU_CAN_DELETE_YOUR_ACCOUNT_HERE_A', '您可以在此删除您的账户。开始注销后，需三天才能完成账户注销。您可在最初 24 小时内取消此流程。');
define('TZ_YOU_DON_T_HAVE_ENOUGH_GOLD_YOU_NEE', '您的金币不足。即时拆除需要 10 金币。');
define('TZ_YOU_HAVE_BEEN_ENTERED_AS_SITTER_ON', '您已被设为以下账户的代理人。您可以点击红色 X 取消。');
...
define('TZ_ML_LEADER_DEMOLITION_EMBASSY', '由于您是联盟的领袖，您当前大使馆的拆除无法开始，因为它仍保有您所有的');
define('TZ_ML_CHANGELOG_120BUGS', '修复超过 120 个 bug，神器完全修复，投石车和冲车完全修复，自动化纳塔/神器/世界奇迹村庄/世界奇迹建筑图纸，新战斗公式（比旧的更精确），神器自动激活，重写了大量代码。详见 readme 文件！');
define('TZ_ML_CHANGELOG_NEWFORUM', '全新论坛系统，Travian 式陷阱公式，修复总管，使用 Plus 时铁匠铺和兵工厂双研究队列');
define('TZ_ML_GOLD_RESERVE', '基本上，我们会在付款后立即预留所订购的金币数量。如有任何问题，请发送电子邮件至我们的');
define('TZ_ML_GPACK_NOTFOUND', '未找到图形包。可能由以下原因导致：');
define('TZ_ML_GPACK_ALLOWED_SAVE', '显示允许的图形包。保存您的选择以激活它。');
define('TZ_ML_GPACK_ALTER_APPEARANCE', '使用图形包，您可以改变 Travian 的外观。您可以从列表中选择一个，或提供自定义路径。');
define('TZ_ML_QUESTIONS_MULTIHUNTER', '。如果您有疑问或想举报违规行为，可以给多猎手发消息。');
define('TZ_ML_AWAY_NO_SITTER', '如果您打算长时间离开且不想设置代理人，可以启用');
define('TZ_ML_ACCOUNT_FROZEN', '。在此期间，您的账户基本处于冻结状态。资源、部队或研究都不会推进，您的村庄也不会被攻击。请记住，这只冻结您的 Travian，而非时间。');
define('TZ_ML_ACTIVATION_RESENT', '。然后将重新发送激活码');
define('TZ_ML_TWO_SITTERS_RIGHT', '每位玩家有权指定两名代理人，在所有者不在时代为操作账户。代理人必须以账户的最大利益操作其所代管的账户。滥用此功能将受到处罚。');
define('TZ_ML_SAME_COMPUTER_SITTER', '使用同一台电脑并希望访问彼此账户的玩家必须使用代理人功能。');
define('TZ_ML_POLITE_TONE', '所有人都必须以礼貌、友好的语气交流。多猎手可不经警告更改不当的个人资料和村庄名称。');
define('TZ_ML_MATERIAL_UNDERAGE', '发布或传播任何不适合未成年人的内容。');
...
define('TZ_RPT_SCOUT', "侦察报告");
define('TZ_RPT_WON_ATK_NOLOSS', "作为攻击方获胜且无损失");
define('TZ_RPT_WON_ATK_LOSS', "作为攻击方获胜但有损失");
define('TZ_RPT_LOST_ATK_LOSS', "作为攻击方失败且有损失");
define('TZ_RPT_WON_DEF_NOLOSS', "作为防御方获胜且无损失");
define('TZ_RPT_WON_DEF_LOSS', "作为防御方获胜但有损失");
define('TZ_RPT_LOST_DEF_LOSS', "作为防御方失败且有损失");
define('TZ_RPT_LOST_DEF_NOLOSS', "作为防御方失败且无损失");
define('TZ_RPT_REINF_ARRIVED', "增援已抵达");
define('TZ_RPT_WOOD_DELIVERED', "木材已送达");
define('TZ_RPT_CLAY_DELIVERED', "黏土已送达");
define('TZ_RPT_IRON_DELIVERED', "铁矿已送达");
define('TZ_RPT_CROP_DELIVERED', "粮食已送达");
define('TZ_RPT_WON_SCOUT_ATK', "作为攻击方侦察成功");
