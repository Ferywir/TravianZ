...
define('Q25_14_DESC', 'It`s getting time to erect a cranny. The world of <b>'.SERVER_NAME.'</b> is dangerous.<br><br>Many players live by stealing other player`s resources. Build a cranny to hide some of your resources from enemies.');
...
define('TZ_ACTIVATION_AVAILBLE_IN', 'Activation Availble in:');
define('TZ_ACTIVATION_CODE', 'Activation code:');
define('TZ_ADD', 'add');
define('TZ_ADD_2', 'Add');
define('TZ_ALLIANCE_ID', 'Alliance ID');
define('TZ_ARRIVED', 'Arrived:');
define('TZ_ASSIGN_TO_POSITION', 'Assign to position');
define('TZ_AS_SOON_AS_A_PLAYER_YOU_INVITED_FO', 'As soon as a player you invited founds his');
define('TZ_ATTACKS', 'Attacks');
define('TZ_BOLD', 'bold');
define('TZ_BUILDING', 'Building');
define('TZ_CATAPULT_TARGET', 'catapult target');
define('TZ_CLICK_TO_COPY', 'Click to copy');
define('TZ_CLIMBERS_OF_THE_WEEK', 'Climbers of the week');
define('TZ_CLOCK', 'Clock');
define('TZ_CONTINUE_WITH_THE_NEXT_TASK', 'Continue with the next task.');
define('TZ_CREATE', 'Create');
define('TZ_CREATE_A_NEW_LIST', 'Create a new list');
define('TZ_DESTINATION', 'Destination:');
define('TZ_DOES_NOT_EXIST', 'does not exist.');
define('TZ_DOWNLOAD', 'Download');
define('TZ_EVENT', 'Event');
define('TZ_FEATURES_OF_TRAVIAN', 'Features of Travian');
define('TZ_FORUM_NAME', 'Forum name');
define('TZ_FORWARD', 'forward');
define('TZ_GOLD', 'gold.');
define('TZ_HERO_DEF_BONUS', 'Hero (def bonus)');
define('TZ_HERO_FIGHTING_STRENGTH', 'Hero (fighting strength)');
define('TZ_HERO_OFF_BONUS', 'Hero (off bonus)');
define('TZ_HOUR', 'hour');
define('TZ_HOW_IS_IT_DONE', 'How is it done?');
define('TZ_HRS', 'hrs');
define('TZ_HRS_2', 'hrs.');
define('TZ_IF_YOU_GET_NEW_PLAYERS_TO_OPEN_AN', 'If you get new players to open an account and settle a second village, you will receive');
define('TZ_IN_YOUR_POST_BECAUSE_IT_CAN_CAUSE', 'in your post because it can cause problem with bbcode system.');
define('TZ_ITALIC', 'italic');
define('TZ_LAST_TARGETS', 'Last targets:');
define('TZ_LIST_NAME', 'List name:');
define('TZ_LOOK_FOR_YOUR_RANK_IN_THE_STATISTI', 'Look for your rank in the statistics and enter it here.');
define('TZ_MACEMAN', 'Maceman');
define('TZ_MEMBERS', 'Members');
define('TZ_MEMBER_SINCE', 'Member since');
define('TZ_NAME', 'Name:');
define('TZ_NO', 'No.');
define('TZ_NOT_CODED_YET', '(not coded yet)');
define('TZ_NO_EMAIL_RECEIVED', 'No email received?');
define('TZ_N_15_GOLD', '15 Gold');
define('TZ_N_1_INVITE_YOUR_FRIENDS_VIA_EMAIL', '1) Invite your friends via Email');
define('TZ_N_20_GOLD', '20 Gold');
define('TZ_N_2_COPY_YOUR_PERSONAL_REF_LINK_AN', '2) Copy your personal REF-Link and share it!');
define('TZ_N_50_GOLD', '50 gold');
define('TZ_OK_2', 'Ok');
define('TZ_OPEN_FORUM_FOR_THE_FOLLOWING_PLAYE', 'Open forum for the following players');
define('TZ_OPEN_FOR_MORE_ALLIANCES', 'Open for more alliances');
define('TZ_ORDER', 'Order:');
define('TZ_OTHER', 'Other');
define('TZ_OWNER', 'Owner:');
define('TZ_PAY_SECURELY_WITH_PAYPAL', 'Pay securely with PayPal.');
define('TZ_PLAYERS_BROUGHT_IN', 'Players brought in');
define('TZ_POST_NEW_THREAD', 'Post new thread');
define('TZ_PREVIEW', 'Preview');
define('TZ_PREVIEW_2', 'preview');
define('TZ_PROGRESS_OF_YOUR_INVITED_FRIENDS', 'Progress of your invited friends');
define('TZ_QUIT_ALLIANCE', 'Quit alliance');
define('TZ_REGISTER_FOR_THE_GAME', 'register for the game');
define('TZ_REGISTRATION', 'registration');
define('TZ_SENT', 'Sent:');
define('TZ_SMILIES', 'Smilies');
define('TZ_SMILIES_2', 'smilies');
define('TZ_STONEMASON_S_LODGE', 'Stonemason\'s Lodge');
define('TZ_TAG', 'Tag:');
define('TZ_TARGET_VILLAGE', 'Target village:');
define('TZ_TASK_10_CRANNY', 'Task 10: Cranny');
define('TZ_TASK_11_TO_TWO', 'Task 11: To Two.');
define('TZ_TASK_12_INSTRUCTIONS', 'Task 12: Instructions');
define('TZ_TASK_13_MAIN_BUILDING', 'Task 13: Main Building');
define('TZ_TASK_14_ADVANCED', 'Task 14: Advanced!');
define('TZ_TASK_16_ECONOMY', 'Task 16: Economy');
define('TZ_TASK_16_MILITARY', 'Task 16: Military');
define('TZ_TASK_17_BARRACKS', 'Task 17: Barracks');
define('TZ_TASK_17_WAREHOUSE', 'Task 17: Warehouse');
define('TZ_TASK_18_MARKETPLACE', 'Task 18: Marketplace.');
define('TZ_TASK_18_TRAIN', 'Task 18: Train.');
define('TZ_TASK_19_EVERYTHING_TO_2', 'Task 19: Everything to 2.');
define('TZ_TASK_20_ALLIANCE', 'Task 20: Alliance.');
define('TZ_TASK_21_MAIN_BUILDING_TO_LEVEL_5', 'Task 21: Main Building to Level 5');
define('TZ_TASK_22_GRANARY_TO_LEVEL_3', 'Task 22: Granary to Level 3.');
define('TZ_TASK_23_WAREHOUSE_TO_LEVEL_7', 'Task 23: Warehouse to Level 7.');
define('TZ_TASK_24_ALL_TO_FIVE', 'Task 24: All to five!');
define('TZ_TASK_25_PALACE_OR_RESIDENCE', 'Task 25: Palace or Residence?');
define('TZ_TASK_26_3_SETTLERS', 'Task 26: 3 settlers.');
define('TZ_TASK_27_NEW_VILLAGE', 'Task 27: New Village.');
define('TZ_TASK_3_YOUR_VILLAGE_S_NAME', 'Task 3: Your Village\'s Name');
define('TZ_TASK_9_DOVE_OF_PEACE', 'Task 9: Dove of Peace');
define('TZ_TERMS', 'Terms');
define('TZ_THE_ALLIANCE', 'The alliance');
define('TZ_THE_LARGEST_ALLIANCES', 'The largest alliances');
define('TZ_THE_USER', 'The user');
define('TZ_THREAD', 'Thread');
define('TZ_TOP_10', 'Top 10');
define('TZ_TOTAL', 'Total');
define('TZ_TOWNHALL', 'Townhall');
define('TZ_TRAVIAN', 'Travian');
define('TZ_TRAVIANX', 'TravianX');
define('TZ_TRAVIANZ', 'TravianZ');
define('TZ_TRAVIAN_GAMES', 'Travian Games');
define('TZ_UNDERLINE', 'underline');
define('TZ_UNDERLINED', 'underlined');
define('TZ_UNKNOWN', 'unknown');
define('TZ_UNTIL_THE_NEXT_LEVEL', 'until the next level');
define('TZ_USER_ID', 'User ID');
define('TZ_VILLAGE', 'Village:');
define('TZ_VILLAGE_OVERVIEW', 'Village overview');
define('TZ_WAIT_INSTANT', 'Wait: instant');
define('TZ_WARNING', 'Warning:');
define('TZ_WOOD', 'Wood');
define('TZ_YOUR_PERSONAL_REF_LINK', 'Your personal REF Link:');
define('TZ_YOU_CAN_T_USE_THE_VALUES', 'you can\'t use the values');
define('TZ_YOU_HAVE_NOT_BROUGHT_IN_ANY_NEW_PL', 'You have not brought in any new players yet.');

// ===== i18n etape 2 (lot suivant) =====
define('TZ_ACCOUNT_IS_ADMIN_OR_MH', 'Account is Admin or MH');
define('TZ_ACCOUNT_IS_NOT_SCHEDULED_FOR_DELET', 'Account is not scheduled for deletion');
define('TZ_ACCOUNT_STATEMENT', 'Account Statement');
define('TZ_ACTIVATE_VACATION_MODE', 'Activate Vacation Mode');
define('TZ_ADD_RAID', 'Add Raid');
define('TZ_ADD_SLOT', 'Add Slot');
define('TZ_ADVANTAGES', 'Advantages');
define('TZ_AFTER_PAYMENT_YOU_WILL_BE_CREDITED', 'After payment you will be credited automatically.');
define('TZ_AGRESOR', 'Agresor');
define('TZ_ALLIANCE_DIPLOMACY', 'Alliance diplomacy');
define('TZ_ALLIANCE_EVENTS', 'Alliance events');
define('TZ_ALLIANCE_FORUM', 'Alliance Forum');
define('TZ_ALLIANCE_MEMBERS', 'alliance members.');
define('TZ_ALLY_CHAT', 'Ally-Chat');
define('TZ_AM', 'am');
define('TZ_AND_LATER_YOUR_VILLAGE_COULD_LOOK', '...and later your village could look like that.');
define('TZ_AND_QUIT_THE_ALLIANCE_AFTERWARDS', 'and quit the alliance afterwards.');
define('TZ_ASSIGN_RIGHTS', 'Assign rights');
define('TZ_ATTENTION_USE_ONLY_TRUSTWORTHY_GRA', 'ATTENTION! Use only trustworthy graphic packs');
define('TZ_AUTHOR', 'Author');
define('TZ_BEGINNERS_PROT', 'Beginners Prot.');
define('TZ_BEST_PLAYER', 'Best Player');
define('TZ_BUILDING_SITE', 'building site');
define('TZ_BUILD_A_PALACE_OR_RESIDENCE_TO_LEV', 'Build a palace or residence to level 10.');
define('TZ_BUILD_CROPPER', 'Build Cropper');
define('TZ_BUY_IT_IN_THE_GOLD_SHOP', 'Buy it in the Gold Shop');
define('TZ_CELEBRATION_STILL_NEEDS', 'celebration still needs:');
define('TZ_CENTRE', 'Centre:');
define('TZ_CHANGE_NAME', 'Change name');
define('TZ_CHANGE_YOUR_VILLAGE_S_NAME_TO_SOME', 'Change your village\'s name to something nice.');
define('TZ_CHINESE', 'Chinese');
define('TZ_CLAY_25_5_GOLD', 'Clay +25% (5 gold)');
define('TZ_CLOSED_FORUM', 'Closed Forum');
define('TZ_CLOSE_ADRESSBOOK', 'close adressbook');
define('TZ_COMBAT_SIMULATOR', 'Combat-Simulator');
define('TZ_COMPLETE_DEMOLITION_10', 'Complete demolition (10');
define('TZ_CONFEDERATION_FORUM', 'Confederation Forum');
define('TZ_CONFIRM_WITH_PASSWORD', 'Confirm with password:');
define('TZ_CONSTRUCT_A_CRANNY', 'Construct a Cranny.');
define('TZ_CONSTRUCT_A_GRANARY', 'Construct a Granary.');
define('TZ_CONSTRUCT_A_RALLY_POINT', 'Construct a rally point.');
define('TZ_CONSTRUCT_A_WOODCUTTER', 'Construct a woodcutter.');
define('TZ_CONSTRUCT_BARRACKS', 'Construct barracks.');
define('TZ_CONSTRUCT_WAREHOUSE', 'Construct Warehouse.');
define('TZ_CP_DAY', 'CP/day');
define('TZ_CROP_25_5_GOLD', 'Crop +25% (5 gold)');
define('TZ_DATE_AND_TIME', 'Date and time');
define('TZ_DECLARE_WAR', 'declare war');
define('TZ_DEFAULT', 'Default:');
define('TZ_DELETE_ACCOUNT', 'Delete account?');
define('TZ_DIFFERENT_EMAIL_ADDRESS', 'different email address');
define('TZ_DOWNLOAD_FROM', 'Download from');
define('TZ_DO_I_NEED_PLUS_TO_USE_OTHER_FEATUR', 'Do I need Plus to use other features?');
define('TZ_EARN_GOLD', 'Earn gold');
define('TZ_EDIT_ANSWER', 'Edit answer');
define('TZ_EDIT_ANSWER_2', 'edit answer');
define('TZ_EDIT_FORUM', 'edit forum');
define('TZ_EDIT_SLOT', 'Edit Slot');
define('TZ_EDIT_TOPIC', 'Edit topic');
define('TZ_ENDS_ON', 'ends on');
define('TZ_ENGLISH', 'English');
define('TZ_ENTER_HOW_MUCH_LUMBER_THE_BARRACKS', 'Enter how much lumber the barracks cost');
define('TZ_EU_DD_MM_YY_24H', 'EU (dd.mm.yy 24h)');
define('TZ_EXAMPLE', 'Example:');
define('TZ_EXISTING_RELATIONSHIPS', 'Existing relationships');
define('TZ_EXTEND_ALL_RESOURCE_TILES_TO_LEVEL', 'Extend all resource tiles to level 1.');
define('TZ_EXTEND_ALL_RESOURCE_TILES_TO_LEVEL_2', 'Extend all resource tiles to level 2.');
define('TZ_EXTEND_ONE_CLAY_PIT', 'Extend one clay pit.');
define('TZ_EXTEND_ONE_CROPLAND', 'Extend one cropland.');
define('TZ_EXTEND_ONE_IRON_MINE', 'Extend one iron mine.');
define('TZ_EXTEND_ONE_OF_EACH_RESOURCE_TILE_T', 'Extend one of each resource tile to level 2.');
define('TZ_EXTEND_YOUR_MAIN_BUILDING_TO_LEVEL', 'Extend your main building to level 3.');
define('TZ_FINISH', 'Finish');
define('TZ_FOLLOWING_CAUSES_ARE_POSSIBLE', 'Following causes are possible:');
define('TZ_FOLLOW_THIS_LINK_TO', 'Follow this link to');
define('TZ_FOREIGN_OFFERS', 'Foreign offers');
define('TZ_FORUM_TYPE', 'Forum type');
define('TZ_FOUND_A_NEW_VILLAGE', 'Found a new village.');
define('TZ_FREE', 'FREE!');
define('TZ_FRENCH', 'French');
define('TZ_FRIEND_EMAIL_COM', 'friend@email.com');
define('TZ_GAME_LANGUAGE', 'Game language');
define('TZ_GITHUB', 'Github');
define('TZ_GRAPHIC_PACK_FOUND', 'Graphic Pack found.');
define('TZ_GRAPHIC_PACK_SETTINGS', 'Graphic pack settings');
define('TZ_GREAT_STABLES', 'Great Stables');
define('TZ_HERE', 'here');
define('TZ_HERE_YOU_CAN_KICK_THE_PLAYERS_FROM', 'Here you can kick the players from your alliance.');
define('TZ_HERE_YOU_FIND_YOUR_RESOURCE_FIELDS', 'Here you find your resource fields');
define('TZ_HINT', 'Hint');
define('TZ_HOW_DO_I_GET_GOLD', 'How do I get Gold?');
define('TZ_INACTIVE_DURING_VACATION', 'Inactive during vacation');
define('TZ_INFORMATION_ON_HAPPENINGS_IN_YOUR', 'Information on happenings in your village');
define('TZ_INITIATE_PAYMENT_BY_PAYPAL', 'Initiate Payment by PayPal');
define('TZ_INVITATIONS', 'Invitations:');
define('TZ_INVITE_A_PLAYER_INTO_THE_ALLIANCE', 'Invite a player into the alliance');
define('TZ_INVITE_BY_E_MAIL_OR_SHARE_YOUR_REF', 'Invite by e-mail or share your REF link.');
define('TZ_IN_DESCRIPTION', 'in description.');
define('TZ_IN_THE_VILLAGE_YOU_CAN_BUILD_BUILD', 'In the village you can build buildings');
define('TZ_IRON_25_5_GOLD', 'Iron +25% (5 gold)');
define('TZ_ISO_YY_MM_DD_24H', 'ISO (yy/mm/dd 24h)');
define('TZ_ITALIAN', 'Italian');
define('TZ_I_ACTIVATED_PLUS_BUT_PRODUCTION_DI', 'I activated Plus, but production did not increase.');
define('TZ_JOIN_AN_ALLIANCE', 'Join an alliance');
define('TZ_JOIN_AN_ALLIANCE_OR_FOUND_ONE_ON_Y', 'Join an alliance or found one on your own.');
define('TZ_JUL', 'Jul');
define('TZ_JUN', 'Jun');
define('TZ_KICK_ALL_MEMBERS', 'kick all members');
define('TZ_KICK_PLAYER', 'Kick Player:');
define('TZ_LANGUAGE_SETTINGS', 'Language settings');
define('TZ_LAST_POST', 'Last post');
define('TZ_LAST_RAID', 'Last raid');
define('TZ_LINKS', 'Links:');
define('TZ_LINK_TO_THE_FORUM', 'Link to the forum');
define('TZ_LOG_IN', 'log in');
define('TZ_LUMBER_25_5_GOLD', 'Lumber +25% (5 gold)');
define('TZ_MAINTENANCE_OFF', 'Maintenance OFF');
define('TZ_MAINTENANCE_ON', 'Maintenance ON');
define('TZ_MAJOR_CHANGES', 'Major Changes:');
define('TZ_MAP_2', 'Map:');
define('TZ_MAXIMUM_VACATION', 'Maximum vacation:');
define('TZ_MESSAGES', 'Messages:');
define('TZ_MESSAGE_3', 'Message');
define('TZ_MILITARY_EVENTS', 'Military events');
define('TZ_MINIMUM_VACATION', 'Minimum vacation:');
define('TZ_MINOR_CHANGES', 'Minor Changes:');
define('TZ_MISCELLANEOUS', 'Miscellaneous');
define('TZ_MORE_GRAPHIC_PACKS', 'More graphic packs');
define('TZ_MORE_INFO', 'More info:');
define('TZ_MOVE_TOPIC', 'Move topic');
define('TZ_MULTIHUNTER', 'Multihunter:');
define('TZ_NEW_FORUM', 'New forum');
define('TZ_NONE_OF_THE_PACKAGES_ARE_REFUNDABL', 'None of the packages are refundable!');
define('TZ_NOT_ENOUGH_RESOURCE', 'Not enough resource');
define('TZ_NO_MARKETPLACE_ACTIVITY', 'No marketplace activity');
define('TZ_NO_OWNERSHIP_OF_AN_ARTIFACT_VILLAG', 'No ownership of an artifact village');
define('TZ_NO_OWNERSHIP_OF_A_WONDER_OF_THE_WO', 'No ownership of a Wonder of the World village');
define('TZ_NO_REINFORCING_TROOPS_SENT_RECEIVE', 'No reinforcing troops sent/receive');
define('TZ_NO_REPORTS_FOR_TRANSFERS_FROM_FORE', 'No reports for transfers from foreign villages.');
define('TZ_NO_REPORTS_FOR_TRANSFERS_TO_FOREIG', 'No reports for transfers to foreign villages.');
define('TZ_NO_REPORTS_FOR_TRANSFERS_TO_OWN_VI', 'No reports for transfers to own villages.');
define('TZ_N_14_DAYS', '14 days');
define('TZ_N_1_1_TRADE_WITH_THE_NPC_MERCHANT', '1:1 Trade with the NPC merchant');
define('TZ_N_1_5_YOUR_VILLAGE', '(1/5) Your village');
define('TZ_N_1_CHOOSE_A_RESOURCE_FIELD', '1. Choose a resource field');
define('TZ_N_1_CHOOSE_BUILDING_SITE', '1. Choose building site');
define('TZ_N_2_5_RESOURCES', '(2/5) Resources');
define('TZ_N_2_CONSTRUCT_A_BUILDING', '2. Construct a building');
define('TZ_N_2_DAYS', '2 days');
define('TZ_N_2_EXTEND_THE_RESOURCE_FIELD', '2. Extend the resource field');
define('TZ_N_3_5_BUILDINGS', '(3/5) Buildings');
define('TZ_N_4_5_NEIGHBOURS', '(4/5) Neighbours');
define('TZ_N_5_5_NAVIGATION', '(5/5) Navigation');
define('TZ_OFFER_A_CONFEDERATION', 'offer a confederation');
define('TZ_OFFER_NON_AGGRESSION_PACT', 'offer non-aggression pact');
define('TZ_OK_3', 'ok');
define('TZ_ONLINE_USERS', 'Online Users');
...
define('TZ_ORDERED_PACKAGE', 'Ordered Package');
define('TZ_OR_ASK_THE_SERVER_OWNER', 'or ask the server owner.');
define('TZ_OVERVIEW', 'Overview:');
define('TZ_OWN_TEXT', 'Own text:');
define('TZ_PALACE_RESIDENCE', 'Palace/Residence');
define('TZ_PASSWORD', 'password:');
define('TZ_PAYMENT_ACCOUNT', 'payment account');
define('TZ_PAYPAL', 'PayPal');
define('TZ_PAYPAL_PACKAGE_A', 'PayPal – Package A');
define('TZ_PAYPAL_PACKAGE_B', 'PayPal – Package B');
define('TZ_PAYPAL_PACKAGE_C', 'PayPal – Package C');
define('TZ_PAYPAL_PACKAGE_D', 'PayPal – Package D');
define('TZ_PAYPAL_PACKAGE_E', 'PayPal – Package E');
define('TZ_PLAY_NO_TASKS', 'Play no tasks.');
define('TZ_PLEASE_BUILD_A_MARKETPLACE', 'Please build a Marketplace.');
define('TZ_PLUS_FUNCTIONS', 'Plus functions');
define('TZ_PM', 'pm');
define('TZ_POP', 'Pop');
define('TZ_POSITION', 'Position:');
define('TZ_PRODUCTION_CLAY', 'Production: Clay');
define('TZ_PRODUCTION_CROP', 'Production: Crop');
define('TZ_PRODUCTION_IRON', 'Production: Iron');
define('TZ_PRODUCTION_LUMBER', 'Production: Lumber');
define('TZ_PUBLIC_FORUM', 'Public Forum');
define('TZ_RAGEZONE_COM', 'RageZone.com');
define('TZ_RANKING_OF_ALL_PLAYERS', 'Ranking of all players');
define('TZ_RATIO', 'ratio');
define('TZ_READ_YOUR_NEW_MESSAGE', 'Read your new message.');
define('TZ_REGISTERED', 'Registered');
define('TZ_REGISTERED_PLAYERS', 'Registered players');
define('TZ_RELEASED_BY_TRAVIANZ_TEAM', 'Released by: TravianZ Team');
define('TZ_RELEASE_BY_TRAVIANZ', '[Release by: TravianZ]');
define('TZ_REPLIES', 'Replies');
define('TZ_REPORTS', 'Reports:');
define('TZ_REQUIREMENTS', 'Requirements');
define('TZ_ROMANIAN', 'Romanian');
define('TZ_SCOUT_DEFENCES_AND_TROOPS', 'Scout defences and troops');
define('TZ_SCOUT_RESOURCES_AND_TROOPS', 'Scout resources and troops');
define('TZ_SCRIPT_PRICE', 'Script Price:');
define('TZ_SELECT_ALL', 'Select all');
define('TZ_SELECT_REWARD', 'Select reward...');
define('TZ_SELECT_REWARD_2', 'Select Reward:');
define('TZ_SEND_200_CROP_TO_THE_TASKMASTER', 'Send 200 crop to the taskmaster.');
define('TZ_SEND_AND_RECEIVE_MESSAGES', 'Send and receive messages');
define('TZ_SEND_UNITS_BACK', 'Send units back');
define('TZ_SERVER_START', 'Server Start');
define('TZ_SHOW_THE_LARGE_MAP_IN_AN_EXTRA_WIN', 'Show the large map in an extra window.');
define('TZ_SIZE_IN_MB', 'Size in MB');
define('TZ_SLOTS', 'Slots');
define('TZ_START_RAID', 'Start Raid');
define('TZ_STATISTICS', 'Statistics:');
define('TZ_SUPPORT', 'Support:');
define('TZ_SUPPORT_AND_MULTIHUNTER', 'Support and Multihunter');
define('TZ_SURVEY', 'survey');
define('TZ_TARIFFS', 'Tariffs');
define('TZ_TASK_7_HUGE_ARMY', 'Task 7: Huge Army!');
define('TZ_TASK_8_EVERYTHING_TO_1', 'Task 8: Everything to 1.');
define('TZ_THANK_YOU_FOR_USING_OUR_VERSION', 'Thank you for using our version!');
define('TZ_THERE_ARE_NO_INCOMING_TROOPS', 'There are no incoming troops');
define('TZ_THERE_ARE_NO_OUTGOING_TROOPS', 'There are no outgoing troops');
define('TZ_THE_BEST_ALLIANCES_DEF', 'The best alliances (def)');
define('TZ_THE_BEST_ALLIANCES_OFF', 'The best alliances (off)');
define('TZ_THE_BUILDING_WAS_COMPLETELY_DEMOLI', 'The building was completely demolished for 10 gold!');
define('TZ_THE_EMAIL_ACCOUNT_S_STORAGE_LIMIT', 'The email account`s storage limit is reached');
define('TZ_THE_EMAIL_HAS_BEEN_MOVED_TO_THE_SP', 'The email has been moved to the spam/junk folder');
define('TZ_THE_EMAIL_WILL_BE_SENT_TO_FOLLOWIN', 'The email will be sent to following address:');
define('TZ_THE_E_MAIL_ADDRESS_OF_THE_NEW_OWNE', 'The e-mail address of the new owner.');
define('TZ_THE_GAME_WORLD_ON_WHICH_THE_ACCOUN', 'The game world on which the account resides');
define('TZ_THE_HERO', 'The hero');
define('TZ_THE_LARGEST_GAULS', 'The largest Gauls');
define('TZ_THE_LARGEST_PLAYERS', 'The largest players');
define('TZ_THE_LARGEST_ROMANS', 'The largest Romans');
define('TZ_THE_LARGEST_TEUTONS', 'The largest Teutons');
define('TZ_THE_LARGEST_VILLAGES', 'The largest villages');
define('TZ_THE_MOST_EXPERIENCED_HEROES', 'The most experienced heroes');
define('TZ_THE_MOST_SUCCESSFUL_ATTACKERS', 'The most successful attackers');
define('TZ_THE_MOST_SUCCESSFUL_DEFENDERS', 'The most successful defenders');
define('TZ_THE_MULTIHUNTERS_ARE_RESPONSIBLE_F', 'The Multihunters are responsible for compliance with');
define('TZ_THE_NAVIGATION_BAR', 'The navigation bar');
define('TZ_THE_NICKNAME_OF_THE_ACCOUNT', 'The nickname of the account');
define('TZ_THE_PATH', 'The path');
define('TZ_THE_VILLAGE', 'The village');
define('TZ_THIS_FEATURE_IS_NOT_INCLUDED_IN_TH', 'This feature is NOT included in the gold club!');
define('TZ_THIS_IS_HOW_YOU_START', 'This is how you start...');
define('TZ_THREADS', 'Threads');
define('TZ_TIME_PREFERENCE', 'Time Preference');
define('TZ_TIME_ZONES', 'Time zones');
define('TZ_TIP', 'Tip');
define('TZ_TOP_10_ALLIANCES', 'Top 10 Alliances');
define('TZ_TOP_10_PLAYERS', 'Top 10 players');
define('TZ_TOTAL_POPULATION', 'Total Population');
define('TZ_TOTAL_VILLAGES', 'Total Villages');
define('TZ_TO_THE_FIRST_TASK', 'To the first task.');
define('TZ_TO_THE_REGISTRATION', 'to the registration');
define('TZ_TRAIN_3_SETTLERS', 'Train 3 settlers.');
...
define('TZ_TRIBES', 'Tribes');
define('TZ_TYPOS_IN_THE_EMAIL_ADDRESS', 'Typos in the email address');
define('TZ_UK_DD_MM_YY_12H', 'UK (dd/mm/yy 12h)');
define('TZ_UPGRADE_ALL_RESOURCES_TILES_TO_LEV', 'Upgrade all resources tiles to level 5.');
define('TZ_UPGRADE_YOUR_GRANARY_TO_LEVEL_3', 'Upgrade your granary to level 3.');
define('TZ_UPGRADE_YOUR_MAIN_BUILDING_TO_LEVE', 'Upgrade your main building to level 5.');
define('TZ_UPGRADE_YOUR_WAREHOUSE_TO_LEVEL_7', 'Upgrade your warehouse to level 7.');
define('TZ_USE', 'Use');
define('TZ_USED_FOR_RALLY_POINT_AND_MARKETPLA', 'Used for rally point and marketplace:');
define('TZ_USERNAME', 'Username');
define('TZ_USER_DEFINED_GRAPHIC_PACK', 'User-defined graphic pack');
define('TZ_USE_IT_FOR_PLUS_OR_ANY_ADVANTAGE', '. Use it for Plus or any advantage.');
define('TZ_US_MM_DD_YY_12H', 'US (mm/dd/yy 12h)');
...
define('TZ_VILLAGE_EXP', 'Village Exp.');
define('TZ_VILLAGE_YOU_GET', 'village, you get');
define('TZ_VILLAGE_YOU_WILL_BE_CREDITED_WITH', 'village, you will be credited with');
define('TZ_VIP_ACCOUNT_10_GOLD_7_DAYS', 'VIP Account (10 gold – 7 days)');
define('TZ_VISIT', 'Visit:');
define('TZ_VOTE', 'Vote');
define('TZ_WAIT_24H', 'Wait: 24h');
define('TZ_WAIT_INSTANT_AFTER_IPN', 'Wait: instant after IPN');
define('TZ_WARNING_CATAPULT_WILL', 'Warning: Catapult will');
define('TZ_WE_STRIVE_TO_ENSURE_SPEEDY_PROCESS', 'We strive to ensure speedy processing!');
define('TZ_WHY_CAN_T_I_FINISH_SOME_BUILDINGS', 'Why can\'t I finish some buildings with Gold?');
define('TZ_WILL_BE_ATTACKED_BY_CATAPULT_S', '(will be attacked by catapult(s))');
define('TZ_WILL_SPAWN_IN', 'will spawn in:');
define('TZ_WOODCUTTER_INSTANTLY_COMPLETED', 'Woodcutter instantly completed.');
define('TZ_WORLD_STATS', 'World Stats');
define('TZ_WRITE_THE_CODE', 'Write the code');
define('TZ_WRONG_DOMAIN_THERE_IS_E_G_NO_AOL_D', 'Wrong domain: There is e.g. no @aol.de, only @aol.com');
define('TZ_YOUR_ACCOUNT_HAS_BEEN_SUCCESSFULLY', 'Your account has been successfully activated.');
define('TZ_YOUR_VILLAGE_AND_YOUR_NEIGHBOURS', 'Your village and your neighbours');
define('TZ_YOU_CAN_UNDO_THE_REGISTRATION_AND', 'You can undo the registration and re-register with a');
define('TZ_YOU_CAN_USE_THIS_GOLD_FOR_PLUS_OR', '. You can use this gold for Plus or any gold advantage.');

// ===== i18n etape 2 (lot suivant) =====
define('TZ_ACCOUNT_OR_INCREASE_YOUR_RESOURCE', '-Account or increase your resource production.To do so click');
define('TZ_ADDITIONALLY_THE_TRAVIAN_TEAM_WILL', 'Additionally, the Travian Team will not provide information concerning bans to any person, other than the account owner.');
define('TZ_ADVERTISEMENT_OF_ANY_KIND_THAT_HAS', 'Advertisement of any kind that has not been permitted by the Travian Team is impermissible.');
define('TZ_AFTERWARDS_BOTH_PARTIES_MUST_REQUE', 'Afterwards, both parties must request the password for their new account via the password retrieval function.');
define('TZ_AFTER_TAKING_CARE_OF_YOUR_RESOURCE', 'After taking care of your resource supply you can start the expansion of your village.');
define('TZ_ANY_SALES_OR_PURCHASES_CONCERNING', 'Any sales or purchases concerning real money regarding accounts, units, villages, resources, services or any other aspect of Travian are impermissible. The sale of Travian accounts as well as any indirect transfer (even as gifts) in connection with auction sites or other money transactions is impermissible.');
define('TZ_AS_A_LEADER_YOU_CAN_ONLY_CHANGE_YO', 'As a leader, you can only change your title. Your rights remain at their maximum.');
define('TZ_A_SITTER_CAN_LOG_INTO_YOUR_ACCOUNT', 'A sitter can log into your account by using your name and his/her password. You can have up to two sitters.');
define('TZ_A_WAREHOUSE_AND_A_GRANARY_ENABLE_Y', 'A warehouse and a granary enable you to store more resources. A cranny saves your resources from getting stolen by enemy raiders.');
define('TZ_BECAUSE_YOU_ARE_THE_ALLIANCE_FOUND', 'Because you are the alliance founder, you need to select a replacement founder before you leave.');
define('TZ_BEFORE_YOU_EXPAND_YOUR_VILLAGE_S_B', 'Before you expand your village\'s buildings, you should develop some resource fields to increase your resource supply.');
define('TZ_BLACKMAILING_PLAYERS_IN_A_WAY_THAT', 'Blackmailing players in a way that violates any of Travian\'s rules in accordance with the General Terms and Conditions.');
define('TZ_COMPLETE_CONSTRUCTION_ORDERS_AND_R', 'Complete construction orders and researches in this village now');
define('TZ_DISPLAYING_BATTLE_REPORTS_OR_MESSA', 'Displaying battle reports or messages in public without consent of both concerned parties.');
define('TZ_EACH_PLAYER_MAY_ONLY_OWN_AND_PLAY', 'Each player may only own and play one account per server.');
define('TZ_ENGLISH_IS_THE_ONLY_LANGUAGE_TOLER', 'English is the only language tolerated in messages and descriptions.');
define('TZ_FOLLOWING_BEHAVIOR_IS_PUNISHABLE_A', 'Following behavior is punishable and applies to all descriptions, the account name, alliance names, village names and messages:');
define('TZ_HERE_YOU_CAN_CHANGE_TRAVIAN_S_DISP', 'Here you can change Travian\'s displayed time to fit your time zone.');
define('TZ_HERE_YOU_CAN_HAVE_A_LOOK_AT_YOUR_V', 'Here you can have a look at your village\'s surrounding area and your neighbours');
define('TZ_HOWEVER_IT_IS_PERMISSIBLE_TO_TRANS', 'However, it is permissible to transfer the password of an account to a person or persons playing on a different game world (or not playing at all) in order to play a single account together.');
...
define('TZ_IF_THERE_IS_AN_OFFENCE_AGAINST_THE', 'If there is an offence against these game rules, the Multihunters and, if necessary, the Administrators will ban the account(s) in question and decide on a proper punishment. Punishments will always exceed the gain of the violation of the rules.');
define('TZ_IF_YOUR_ALLIANCE_WANTS_TO_USE_AN_E', 'If your alliance wants to use an external forum, you can enter the url here.');
define('TZ_IMPERSONATING_OFFICIALS_OR_OFFICIA', 'Impersonating officials or official positions is illegal in any way.');
define('TZ_INCITING_MANIPULATING_ENCOURAGING', 'Inciting, manipulating, encouraging, assisting or conspiring with others to violate any of Travian Rules is impermissible. These rules apply for players that will delete their accounts or are currently deleting their accounts without exception.');
define('TZ_INTO_YOUR_PROFILE_BY_ADDING_IT_TO', 'into your profile by adding it to one of the two description fields.');
define('TZ_IN_ORDER_TO_ACTIVATE_YOUR_ACCOUNT', 'In order to activate your account enter the code or click on the link in your email.');
define('TZ_IN_ORDER_TO_PLAY_TRAVIAN_YOU_NEED', 'In order to play Travian you need a valid email address to which the activation code can be send. There are exceptional cases when this email might not arrive.');
define('TZ_IN_ORDER_TO_QUIT_THE_ALLIANCE_YOU', 'In order to quit the alliance you have to enter your password again for safety reasons.');
define('TZ_IN_ORDER_TO_SWITCH_AN_ACCOUNT_WITH', 'In order to switch an account with another person on the same game world, both persons must send an e-mail message to admin@travian.com from the e-mail address currently registered to the account. The e-mail must contain the following information:');
define('TZ_IN_THE_BEGINNING_YOUR_SMALL_VILLAG', 'In the beginning your small village will have just one building.');
define('TZ_IN_TRAVIAN_YOU_ARE_NOT_ALONE_YOU_I', 'In Travian you are not alone; you interact with thousands of other players in the Travian world.');
define('TZ_IT_S_PART_OF_DIPLOMATIC_ETIQUETTE', 'It\'s part of diplomatic etiquette to talk to another alliance before sending an offer.');
define('TZ_MULTIACCOUNTS_ON_THE_SPEED_SERVER', 'Multiaccounts on the speed server and multiaccounts with less than 100 population may be deleted on sight with no prior warning.');
define('TZ_NOW_YOU_HAVE_FULFILLED_ALL_PREREQU', 'Now you have fulfilled all prerequisites required to construct a Marketplace.');
define('TZ_NOW_YOU_KNOW_EVERYTHING_IMPORTANT', 'Now you know everything important about Travian. After registration you can start playing!');
define('TZ_NO_EVERY_GOLD_FEATURE_WORKS_STANDA', 'No. Every gold feature works standalone as long as you have enough gold.');
define('TZ_NO_REAL_WORLD_POLITICS_ARE_ALLOWED', 'No real world politics are allowed in names, messages and descriptions.');
define('TZ_PARTICIPATION_IN_ABUSIVE_DEFAMATOR', 'Participation in abusive, defamatory, sexist, racist or profane language; disparaging any religion, race, nation, gender, age group, or sexual orientation; threatening a person with actions in real life.');
define('TZ_PLAYERS_MAY_TALK_TO_THE_MULTIHUNTE', 'Players may talk to the Multihunter who banned them or an Administrator either via IGM (ingame message) or e-mail. Bans, punishments or deletions are not to be discussed in public (e.g. Chat or Forums). Appeals must be written in English.');
define('TZ_PLEASE_ENTER_YOUR_OLD_AND_YOUR_NEW', 'Please enter your old and your new e-mail addresses. You will then receive a code snippet at both e-mail addresses which you have to enter here.');
define('TZ_PLUS_DOES_NOT_INCLUDE_PRODUCTION_B', 'Plus does not include production bonuses. You must buy +25% for each resource separately in');
define('TZ_PROGRAM_ERRORS_ALSO_CALLED_BUGS_MA', 'Program errors (also called bugs) may not be used to one\'s benefit. Abuse can lead to a punishment of the account.');
define('TZ_RESIDENCE_PALACE_AND_WORLD_WONDER', 'Residence, Palace and World Wonder villages are excluded for gameplay reasons.');
define('TZ_RESOURCES_BUILDINGS_VILLAGES_OR_TR', 'Resources, buildings, villages or troops lost during the time of suspension do not count as punishment and will not be replaced by the Travian Team. No player has the right to claim payment or replacement for Plus/Gold time lost due to suspension.');
define('TZ_SHOOT_WITH_A_NORMAL_ATTACK_THEY_DO', 'shoot with a normal attack (they dont shoot with raids!)');
define('TZ_SOMETIMES_THE_EMAIL_IS_MOVED_TO_TH', 'Sometimes the email is moved to the spam folder. For further help click');
define('TZ_THERE_ARE_FOUR_DIFFERENT_TYPES_OF', 'There are four different types of resources in Travian: lumber, clay, iron and crop.');
...
define('TZ_THERE_IS_NO_COMPENSATION_FOR_DAMAG_2', 'There is no compensation for damages done by someone knowing the password of an account. The person receiving the password is subjected to the rules of Travian as well as the General Terms and Conditions.');
define('TZ_THERE_IS_NO_SPECIAL_TREATMENT_FOR', 'There is no special treatment for Travian Plus/Gold users regarding the game rules neither in the time needed to deal with the case nor in the punishment.');
...
define('TZ_THE_FOLLOWING_SET_OF_RULES_ARE_IN', 'The following set of rules are in conjunction to the General Terms and Conditions of Travian. You should familiarize yourself with the General Terms and Conditions to verify what is allowed and what is prohibited, especially in case of an account that has been banned for a rule violation.');
define('TZ_THE_GAME_MUST_BE_PLAYED_WITH_AN_UN', 'The game must be played with an unmodified internet browser. The use of scripts or bots which automate account actions is against the rules.');
define('TZ_THE_OWNER_OF_AN_ACCOUNT_MAY_NOT_TR', 'The owner of an account may not transfer the password of an account to any person playing on the same game world (server). Additionally, knowingly choosing the same password on the same game world as another person is illegal; any of these actions is considered multiaccounting, as defined in these rules.');
define('TZ_THE_PLAYERS_IN_YOUR_SURROUNDING_AR', 'The players in your surrounding area are most important to you. Thanks to the map you have a good overview of who they are.');
define('TZ_THE_REGISTRATION_WAS_SUCCESSFUL_IN', 'The registration was successful. In the next few minutes you will receive an email with the access information.');
define('TZ_THE_SUPPORT_IS_A_GROUP_OF_EXPERIEN', 'The support is a group of experienced players who will answer your questions gladly.');
define('TZ_THE_TRAVIAN_TEAM_RESERVES_THE_RIGH', 'The Travian Team reserves the right to change the rules at any time.');
define('TZ_TO_BRING_IN_NEW_PLAYERS_INVITE_THE', 'To bring in new players, invite them by e-mail or share your REF link.');
define('TZ_VACATION_MODE_CANNOT_BE_ACTIVATED', 'Vacation mode cannot be activated – requirements not met');
define('TZ_WE_WILL_SHOW_YOU_HOW_TO_EXPAND_YOU', 'We will show you how to expand your village so that it becomes a mighty and prosperous city on the next page.');
define('TZ_YOU_CAN_DELETE_YOUR_ACCOUNT_HERE_A', 'You can delete your account here. After starting the cancellation it will take three days to complete the cancellation of your account. You can cancel this process within the first 24 hours.');
define('TZ_YOU_DON_T_HAVE_ENOUGH_GOLD_YOU_NEE', 'You don\'t have enough gold. You need 10 gold for instant demolition.');
define('TZ_YOU_HAVE_BEEN_ENTERED_AS_SITTER_ON', 'You have been entered as sitter on the following accounts. You can cancel this by clicking the red X.');

// ===== i18n composites (Simulateur) =====
define('TZ_NUMBER', 'Number');
define('TZ_LVL', 'Lvl');

// ===== i18n reliquat multi-lignes =====
define('TZ_ML_LEADER_DEMOLITION_EMBASSY', 'Because you are the leader of your alliance, demolition of your current Embassy cannot be started, since it still holds all of your');
define('TZ_ML_CHANGELOG_120BUGS', 'Over 120 bugs fixed, artifacts fully fixed, catapults and rams fully fixed, automated Natars/Artifacts/WW villages/WW building plans, new battle formula (more precise than the old one), automatic artifacts activation, rewritten a lot of code. See more in readme file!');
define('TZ_ML_CHANGELOG_NEWFORUM', 'New forum system, Travian-like trapper formula, fixed master builder, double research queue in blacksmith and armoury with plus');
define('TZ_ML_GOLD_RESERVE', 'Basically, we reserve the ordered amount of gold immediately after the payment. If there are any problems, please send an email to our');
define('TZ_ML_GPACK_NOTFOUND', 'Graphic Pack could not be found. This could be due to the following reasons:');
define('TZ_ML_GPACK_ALLOWED_SAVE', 'shows an allowed Graphic Pack. Save your choice to activate it.');
define('TZ_ML_GPACK_ALTER_APPEARANCE', 'With a graphic pack you can alter the appearance of Travian. You can choose one from the list or provide a custom path.');
define('TZ_ML_QUESTIONS_MULTIHUNTER', '. If you have questions or want to report a violation, you can message a Multihunter.');
define('TZ_ML_AWAY_NO_SITTER', 'If you plan on being away for an extended period of time and do not wish to set a sitter, you can activate');
define('TZ_ML_ACCOUNT_FROZEN', '. During this time your account is essentially frozen. No resources, troops or research will progress and your villages cannot be attacked. Remember, this just freezes your Travian, not time.');
define('TZ_ML_ACTIVATION_RESENT', '. Then the activation code will be send again');
define('TZ_ML_TWO_SITTERS_RIGHT', 'Every player has the right to name two sitters who may play the account during the owner\'s absence. Sitters must play the account they are sitting to the account’s full benefit. Abuse of this function is punishable.');
define('TZ_ML_SAME_COMPUTER_SITTER', 'Players using the same computer and wanting to access each other\'s account must use the sitter function.');
define('TZ_ML_POLITE_TONE', 'Everyone must communicate in a polite, conversational tone. Multihunters may change inappropriate profiles and village names without warning.');
define('TZ_ML_MATERIAL_UNDERAGE', 'Posting or transmission of any material not suitable for underage persons.');

// ===== i18n reliquat final =====
define('TZ_NO_BEGINNER_PROT2', 'No beginner’s protection');
define('TZ_SERVER_RUNNING_ON', '▶ Server running on');
